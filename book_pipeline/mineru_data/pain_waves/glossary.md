# Pain《The Physics of Vibrations and Waves, 6th》翻譯規範
...
### 振動與振盪（ch1–ch4，Pain 特有）

| en | zh-TW |
|---|---|
| vibration | 振動 |
| oscillation | 振盪 |
| simple harmonic motion (SHM) | 簡諧運動 |
| harmonic oscillator | 諧振子 |
| displacement | 位移 |
| amplitude | 振幅 |
| period | 週期 |
| restoring force | 回復力 |
| spring constant | 彈簧常數 / 勁度 |
| stiffness | 勁度 |
| pendulum | 擺 |
| simple pendulum | 單擺 |
| mass on a spring | 彈簧質點 |
| equilibrium position | 平衡位置 |
| potential energy | 位能 |
| kinetic energy | 動能 |
| total energy | 總能量 |
| damping | 阻尼 |
| damped oscillation | 阻尼振盪 |
| damped simple harmonic motion | 阻尼簡諧運動 |
| damping force | 阻尼力 |
| damping coefficient | 阻尼係數 |
| heavy damping / overdamping | 過阻尼 |
| critical damping | 臨界阻尼 |
| light damping / underdamping | 欠阻尼 |
| logarithmic decrement | 對數遞減量 |
| relaxation time | 弛豫時間 |
| quality factor (Q) | 品質因數 Q |
| forced oscillator | 受迫振盪子 |
| forced oscillation | 受迫振盪 |
| driving force | 驅動力 |
| transient | 暫態 |
| steady state | 穩態 |
| resonance | 共振 |
...
| bandwidth | 頻寬 |
| power absorption | 功率吸收 |
| impedance | 阻抗 |
| mechanical impedance | 機械阻抗 |
| reactance | 電抗 / 抗 |
| admittance | 導納 |
| coupled oscillations | 耦合振盪 |
| coupled oscillator | 耦合振盪子 |
| normal mode | 簡正模 |
| normal coordinate | 簡正座標 |
| degree of freedom | 自由度 |
| in phase / out of phase | 同相 / 反相 |
| beats | 拍 |
| mass-loaded string | 負載弦 |
...
| progressive wave | 行進波 |
| wave equation | 波動方程 |
| wave velocity | 波速 |
| transverse impedance | 橫向阻抗 |
| characteristic impedance | 特性阻抗 |
| string | 弦 |
| tension | 張力 |
| linear density | 線密度 |
| reflection coefficient | 反射係數 |
| transmission coefficient | 透射係數 |
| impedance matching | 阻抗匹配 |
| energy density | 能量密度 |
| energy flux / intensity | 能流 / 強度 |
| node / antinode | 節點 / 腹點 |
| boundary condition | 邊界條件 |
| sound wave | 聲波 |
| acoustic | 聲學的 |
| compression / rarefaction | 壓縮 / 稀疏 |
| bulk modulus | 體積模量 |
| pressure wave | 壓力波 |
| transmission line | 傳輸線 |
| inductance per unit length | 單位長度電感 |
| capacitance per unit length | 單位長度電容 |
| telegraphy equation | 電報方程 |
| matched line | 匹配線 |
...
| wave packet | 波包 |
| wavefront | 波前 |
| Doppler effect | Doppler 效應 |

### Fourier 與光學（ch10–ch12，Pain 特有）

| en | zh-TW |
|---|---|
| Fourier series | Fourier 級數 |
| Fourier transform | Fourier 變換 |
| Fourier analysis | Fourier 分析 |
| harmonic | 諧波 |
...
| interference | 干涉 |
| coherence | 同調性 |
| coherent / incoherent | 同調 / 非同調 |
| Young's slits | Young 雙狹縫 |
| double slit | 雙狹縫 |
| single slit | 單狹縫 |
| diffraction grating | 繞射光柵 |
| Fraunhofer diffraction | Fraunhofer 繞射 |
| Fresnel diffraction | Fresnel 繞射 |
| fringe | 條紋 |
| optical path | 光程 |
| path difference | 光程差 |
| resolving power | 解析力 |
| Rayleigh criterion | Rayleigh 判據 |
| Michelson interferometer | Michelson 干涉儀 |
| Fabry–Perot | Fabry–Perot |
| thin film | 薄膜 |
| Newton's rings | Newton 環 |
| aperture | 孔徑 |

### 波動力學與非線性（ch13–ch15、附錄，Pain 特有）
...
| eigenfunction | 本徵函數 |
| potential well | 位能井 |
| potential barrier | 位能障 |
| tunnelling | 穿隧 |
| expectation value | 期望值 |
| uncertainty principle | 測不準原理 |
| non-linear | 非線性 |
| non-linear oscillation | 非線性振盪 |
| chaos | 混沌 |
| chaotic | 混沌的 |
| phase space | 相空間 |
| attractor | 吸子 |
...
| soliton | 孤立子 |
| solitary wave | 孤立波 |
| Korteweg–de Vries equation | Korteweg–de Vries 方程 |
| dispersion | 色散 |
| non-linearity | 非線性 |
| statistical physics | 統計物理 |
