# Shankar《Principles of Quantum Mechanics, 2nd》翻譯規範
...
| determinant | 行列式 |
| Poisson bracket | Poisson 括號 |
| canonical transformation | 正則變換 |
| Lagrangian / Hamiltonian formalism | Lagrangian / Hamiltonian 表述 |
| variational method | 變分法 |
| WKB method | WKB 方法 |
| rotational invariance | 轉動不變性 |
